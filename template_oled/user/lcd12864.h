...
#define RS_Port  GpioPortA
#define RS_Pin 	 GpioPin6
...
#define LCD12864_DATA_MODE  Gpio_WriteOutputIO(RS_Port, RS_Pin, 1);
...
#define LCD12864_SendCMD(cmd) {LCD12864_CMD_MODE; while(Spi_GetStatus(M0P_SPI0, SpiTxe) == FALSE);Spi_SendData(M0P_SPI0,cmd);}
#define LCD12864_SendDATA(data) {LCD12864_DATA_MODE; while(Spi_GetStatus(M0P_SPI0, SpiTxe) == FALSE);Spi_SendData(M0P_SPI0,data);}
...
typedef enum
{
		FONT32_DEFAULT 	= (0x80+32),	//24∫≈,µ˛º”œ‘ æ
